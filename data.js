...
const COURSE = {
  ...
  {name:"Number Sense", days:[
    ...
    {d:7, iso:"2026-09-10", topic:"Quiz: Current Topic  &  Integer and Fraction Operations", flag:"quiz",
      extras:[]},
  ...
  {name:"Algebra", days:[
    ...
    {d:21, iso:"2026-09-30", topic:"Quiz: Current Topic  &  Fraction Operations", flag:"quiz",
      extras:[]},
  ...
  {name:"Linear Relations", days:[
    ...
    {d:35, iso:"2026-10-22", topic:"Quiz: Current Topic  &  Like terms and Polynomial Operations", flag:"quiz",
      extras:[]},
  ...
  {name:"Data and Modelling", days:[
    ...
    {d:58, iso:"2026-11-25", topic:"The Modelling Process: Understanding the Situation", num:"5.5",
      note:"", ans:"", extras:[]},
    {d:59, iso:"2026-11-26", topic:"Quiz: Current Topic  &  y = mx + b Substitution", flag:"quiz",
      extras:[]},
  ...
  {name:"Geometry and Measurement", days:[
    ...
    {d:67, iso:"2026-12-08", topic:"The Pythagorean Relationship", num:"6.4",
      note:"", ans:"", extras:[]},
    {d:68, iso:"2026-12-09", topic:"Quiz: Current Topic  &  Solving Equations and Proportional Reasoning", flag:"quiz",
      extras:[]},
